...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      <div className="flex flex-row items-center justify-between w-[100%] h-[320px] bg-red-200">
        <Carousel3>
          {slides.map((s) => (
            <Image key={s.title} src={s.imgUrl} alt={s.description} width={500} height={500} />
          ))}
        </Carousel3>
      </div>
